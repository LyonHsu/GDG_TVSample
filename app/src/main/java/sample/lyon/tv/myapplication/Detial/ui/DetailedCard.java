...
package sample.lyon.tv.myapplication.Detial.ui;
...
public class DetailedCard {
    ...
    @SerializedName("backageImage") private String backageImage = null;
    ...
    public String toString(){
        return " mTitle:"+mTitle+" mDescription:"+mDescription+" mText:"+mText+
                " mLocalImageResource:"+mLocalImageResource+" mPrice:"+mPrice+
                " mYear:"+mYear+" mTrailerUrl:"+mTrailerUrl+" mVideoUrl:"+mVideoUrl;
    }
}
